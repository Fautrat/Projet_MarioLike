...
MainUI::MainUI(AssetsManager& assets, sf::RenderWindow& window, Map* map) : GameUI() {
	...
	scoreText.setFont(assets.getFRef("space"));
	scoreText.setCharacterSize(MIDDLE_FONT_SIZE);
	scoreText.setPosition(sf::Vector2f(10, 10));

	//Life
	lifeText.setString("LIFE :");
	lifeText.setFont(assets.getFRef("space"));
...
StartMenu::StartMenu(AssetsManager& assets, sf::RenderWindow& window) : GameUI() {
	...
	title.setFont(assets.getFRef("space"));
	...
	message1.setFont(assets.getFRef("space"));
	...
	message2.setFont(assets.getFRef("space"));
	...
	//Credits
	credits.setString("Credits : Paul COIFFIN, Arthur FOURFOOZ, Enzo FAUTRAT");
	credits.setFont(assets.getFRef("space"));
